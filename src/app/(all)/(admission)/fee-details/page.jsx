  ...
  return (
    <>
      ...
      <div className="w-full">
        <table className="table-auto w-full border-collapse border border-gray-300 text-xs md:text-base text-center">
          <thead>
            <tr>
              <th className="border-2 border-gray-300 px-2 py-2">Courses</th>
              <th className="border-2 border-gray-300 px-2 py-2">Courses Fees</th>
              <th className="border-2 border-gray-300 px-2 py-2">Duration</th>
            </tr>
          </thead>
          <tbody>
            <tr>
            ...
            <tr>
              <td className="border-2 border-gray-300 px-2 py-2">M. Pharm</td>
